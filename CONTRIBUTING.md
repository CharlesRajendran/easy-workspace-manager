# Contributing to Workspace Command Manager

First off, thank you for considering contributing to **Workspace Command Manager**! 🎉
...
4. Open the Command Palette (`Cmd+Shift+P` / `Ctrl+Shift+P`) and type:
   `Workspace Command Manager: Open Workspace Command Manager Dashboard`
5. Alternatively, click the **Workspace Command Manager** icon in the Activity Bar or status bar.
...
Thank you for helping make **Workspace Command Manager** better for everyone!
